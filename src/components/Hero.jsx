  ...
  return (
    <section className="mt-7.5" role="region" aria-label="Hero section">
      <div className="bg-accent-400 rounded-2xl p-7.5 lg:px-17 sm:flex sm:items-center gap-5 justify-between max-w-[75rem] mx-auto">
        <div className=" max-w-[25.25rem] sm:max-w-[50%] md:max-w-[45%] lg:max-w-[48%]">
          <h1 className="font-fredoka text-xl leading-[39px] font-medium text-primary  md:text-[45px] lg:text-[52px] lg:leading-[60px] md:leading-[50px]">
            The Coolest <br />
